...
public function post()
{
    ...
    if ($checkuser) {
        $categories = Category::all(); // Retrieve all categories
         ...
         return view('components.post',['categories' => $categories]);
    } else {
        return view('update');
    }
}
...
public function verifyAccount(Request $request)
{
    $request->validate([
        ...
        'whatsapp' => 'required',
        'usersid' => 'required',
        'image' => 'required|image|max:8000', // Validate image file
        'ninpic' => 'required|image|max:8000', // Validate image file
    ]);
    ...
    // Move uploaded images to appropriate directories
    ...
    // Create a new VerifiedAccount instance and save it to the database
